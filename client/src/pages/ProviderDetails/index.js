...
const ProviderDetails = () => {
  ...
  const handleButtonToggle = () => {
    if (window.confirm('Deseja escolher este fornecedor?')) {
  ...
  return (
    <main className="ProviderDetails">
      {providerDetails
          ...
          return (
            <section className="details__section" key={_id}>
              ...
              <div className="table__footer">
                ...
                <p>Total: $ {costKwh * minKwhLimit}</p>
              </div>
              <section className="section__btn">
                <button className="btn__choose" onClick={handleButtonToggle}>
                  {isToggleOn ? 'Contratado' : 'Não contratado'}
                </button>
              </section>
            </section>
          );
